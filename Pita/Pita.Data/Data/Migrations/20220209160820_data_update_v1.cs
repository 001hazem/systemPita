...
{
    public partial class data_update_v1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryCompanies", x => new { x.CategoryId, x.CompanyId });
                    table.ForeignKey(
                        name: "FK_CategoryCompanies_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryCompanies_Companies_CompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryCompanies_CompanyId",
                table: "CategoryCompanies",
                column: "CompanyId");
